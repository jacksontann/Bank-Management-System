...
public class User {
     ...
     */
    public User(int userID, String email, String password, LocalDateTime registrationDate) {
        this.userID = userID;
        this.email = email;
        this.password = password;
        this.dateOfRegistry = registrationDate;
    ...
    public User(String email, String password, LocalDateTime registrationDate) {
        this(0, email, password, registrationDate);
    }
    ...
    public void addAllAccounts(List<Account> accountList) {
